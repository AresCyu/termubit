...
The core parameters of the Termubit network are hardcoded to ensure a predictable and transparent monetary policy:
...
| **P2P Port** | 1888 (Default) |
| **RPC Port** | 1889 (Default) |
