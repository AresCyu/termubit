...
// Copyright (c) 2026-2028 Aldianokto
...
{
    const char* pszTimestamp = "Chaos in the Treasury, Order in the Code haha! 29.4.2026/aldianokto";
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x000000438bb42373e25bb18ce5ea222d0f3795f75e49814c85da5e8ef1c290ea"); // 5,050,000
        ...
        // Blocks 14200 - 25334 are Digishield without AuxPoW
        ...
        // Blocks 25334+ are AuxPoW
        auxpowConsensus = digishieldConsensus;
        auxpowConsensus.nHeightEffective = 25334;
        ...
        genesis = CreateGenesisBlock(1386325540, 655719, 0x1e0ffff0, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        auxpowConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
        assert(consensus.hashGenesisBlock == uint256S("0x000000438bb42373e25bb18ce5ea222d0f3795f75e49814c85da5e8ef1c290ea"));
        assert(genesis.hashMerkleRoot == uint256S("0xc6fc347497c2d4e87fd2f43630acf870b4b83d85069052248a0c02d183265205"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (      0, uint256S("000000438bb42373e25bb18ce5ea222d0f3795f75e49814c85da5e8ef1c290ea"))
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1391503289, 997879, 0x1e0ffff0, 1, 75 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        digishieldConsensus.hashGenesisBlock = consensus.hashGenesisBlock;
