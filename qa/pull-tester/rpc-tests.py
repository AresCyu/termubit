...
if 'ENABLE_WALLET' not in vars():
    ENABLE_WALLET=0
if 'ENABLE_TRBCOIND' not in vars():
    ENABLE_TRBCOIND=0
...
#Set env vars
if "TRBCOIND" not in os.environ:
    os.environ["TRBCOIND"] = BUILDDIR + '/src/termubitd' + EXEEXT
...
if not (ENABLE_WALLET == 1 and ENABLE_UTILS == 1 and ENABLE_TRBCOIND == 1):
