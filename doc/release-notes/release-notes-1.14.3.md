...
* Return unspents greater or equal than a specific amount in TRB: minimumAmount (default = 0).
* Return unspents lower or equal than a specific amount in TRB: maximumAmount (default=unlimited).
* Return unspents with a total number lower or equal than a specific number: maximumCount (default=0=unlimited).
* Return unspents which total is greater or equal than a specific amount in TRB: minimumSumAmount (default=unlimited).
