...
Termubit Core verwendet den Port `22556` als Standart-Port zur Kommunikation
...
* [GitHub Diskussionen](https://github.com/termubit/termubit/discussions)
  Wird verwendet, um geplante und ungeplante Funktionen (Features) zu diskutieren, die sich auf die Entwicklung der Termubit Core-Software, die zugrunde liegenden Protokolle und das TRB-Asset beziehen.
