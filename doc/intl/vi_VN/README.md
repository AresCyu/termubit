...
Termubit Core theo mặc định sử dụng cổng `22556` để giao tiếp peer-to-peer điều đó
...
* [GitHub Discussion](https://github.com/termubit/termubit/discussions) được sử dụng để
  ...
  sự phát triển của phần mềm Termubit Core, các giao thức nền tảng và TRB asset.
