...
* [GitHub Discussion](https://github.com/termubit/termubit/discussions) est utilisé pour
  discuter des caractéristiques, planifiées et non planifiées, liées à la fois au développement du logiciel Termubit Core, les protocoles sous-jacents et l'actif TRB.
