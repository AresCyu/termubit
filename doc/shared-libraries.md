...
- `termubitconsensus_ERR_AMOUNT_REQUIRED` - Input amount is required if WITNESS is used

### Example Implementations
- [NBitcoin](https://github.com/NicolasDorier/NBitcoin/blob/master/NBitcoin/Script.cs#L814) (.NET Bindings)
- [node-libtermubitconsensus](https://github.com/bitpay/node-libtermubitconsensus) (Node.js Bindings)
- [java-libtermubitconsensus](https://github.com/dexX7/java-libtermubitconsensus) (Java Bindings)
- [termubitconsensus-php](https://github.com/Bit-Wasp/termubitconsensus-php) (PHP Bindings)
